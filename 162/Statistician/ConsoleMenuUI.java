...
public class ConsoleMenuUI {
	...
	/**
	* Returns the formatted double value, but returns NaN for not-a-number
	...
	*/
	...
	public void print(Statistician s) {
		System.out.println(s.length( ) + " entries total "
				+ formatDouble(s.sum( )) + " with mean of " 
				+ formatDouble(s.mean( )) );
		System.out.println("Largest value is " + formatDouble(s.largest( ))
				+ " and smallest is " + formatDouble(s.smallest( )) );
	}
