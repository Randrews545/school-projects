// File: NodeDouble.java based on the DoubleNode class by Michael Main

/**************************************************************************
* NodeDouble provides a node for a linked list with double data in each node.
*
* @note
...
*
* @author Michael Main 
*   shortened by Beth Katz to be only the basics
*
* @version
*   February 2007
***************************************************************************/
...
{
   // Invariant of the NodeDouble class:
   ...
   **/   
   public NodeDouble(double initialData, NodeDouble initialLink)
   {
      data = initialData;
      link = initialLink;
   }
   ...
   **/
   public void setLink(NodeDouble newLink)
   {                    
      link = newLink;
   }  
}
