...
public class Lab6 {
	...
	*========================================================================*/
		...
		public static void main(String[] args) throws FileNotFoundException {
			...
			int y = 0;
			try {
				List<String> lines = Files.readAllLines(Paths.get("DiveData.txt"));
				lineNum = lines.size();
			} catch (IOException e) {
				e.printStackTrace();
			}
			double [] diveList = new double[lineNum];
			...
			System.out.println("");
				...
				System.out.println(".");
				System.out.println("");
				Arrays.sort(diveList);
				System.out.print("The top three scores are: ");
				System.out.printf("%.2f", diveList[diveNum-1]);
				System.out.print(", ");
				System.out.printf("%.2f", diveList[diveNum-2]);
				System.out.print(", and ");
				System.out.printf("%.2f", diveList[diveNum-3]);
			}
			}